...
def tests_to_run(forwarder):
    from tests import BasicTest, DropTest, SackDropTest, DupTest, SackDupTest, OutOfOrderTest, SackOutOfOrderTest
    test_file = "README"
    # test_file = "test"
    # test_file = "test.png"
    BasicTest.BasicTest(forwarder, test_file)
    DropTest.DropTest(forwarder, test_file)
    DupTest.DupTest(forwarder, test_file)
    OutOfOrderTest.OutOfOrderTest(forwarder, test_file)
    SackDupTest.SackDupTest(forwarder, test_file)
    SackOutOfOrderTest.SackOutOfOrderTest(forwarder, test_file)
    SackDropTest.SackDropTest(forwarder, test_file)
