...
HD_PWD='C:/_SamData/Vivado2022-/PWM_LED/PWM_LED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_LED_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PWM_LED_Top.tcl -notrace
