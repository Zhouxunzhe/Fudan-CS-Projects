...
HD_PWD='C:/_SamData/Vivado2022-/PWM_LED/PWM_LED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_LED_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PWM_LED_Top.tcl
