...
HD_PWD='C:/_SamData/Vivado2022/Codes/VGA/VGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_clkIP_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGA_clkIP_Top.tcl
