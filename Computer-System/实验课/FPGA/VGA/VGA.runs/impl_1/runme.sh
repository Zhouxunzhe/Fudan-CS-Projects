...
HD_PWD='C:/_SamData/Vivado2022/Codes/VGA/VGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_clkIP_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VGA_clkIP_Top.tcl -notrace
