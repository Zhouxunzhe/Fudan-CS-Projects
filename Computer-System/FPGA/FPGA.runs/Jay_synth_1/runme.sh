...
HD_PWD='C:/Vivado_works/Second_Term/FPGA/FPGA.runs/Jay_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Jay.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Jay.tcl
