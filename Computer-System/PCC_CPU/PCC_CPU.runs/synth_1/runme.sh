...
HD_PWD='C:/Vivado_works/Second_Term/PCC_CPU/PCC_CPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log topext.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source topext.tcl
