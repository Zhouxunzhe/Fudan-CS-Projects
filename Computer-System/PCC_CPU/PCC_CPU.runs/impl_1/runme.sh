...
HD_PWD='C:/Vivado_works/Second_Term/PCC_CPU/PCC_CPU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log topext.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source topext.tcl -notrace
